...
fprintf('\nNewton Raphson: %d iterations, average %f iterations, time %f\n',iterations, iterations / nPts, toc);
...
fprintf('\nDamped Least Squares: %d iterations, average %f iterations, time %f\n',iterations, iterations / nPts, toc);
...
fprintf('\nGradient Descent: %d iterations, average %f iterations, time %f\n',iterations, iterations / nPts, toc);

%% Show on Robotics Toolbox
robot = make_robot();
% Show first 100 random
